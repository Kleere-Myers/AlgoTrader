  ...
  return (
    <div className="bg-navy-800 rounded-lg border border-navy-600 overflow-hidden">
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-navy-800 text-text-secondary uppercase text-xs">
        ...
        <tbody className="divide-y divide-navy-600">
          {loading
            ...
            : sorted.map((info) => {
                ...
                return (
                  <tr key={info.symbol} className="hover:bg-navy-700 transition-colors">
                    <td className="px-3 py-2">
                      <Link href={`/quote/${info.symbol}`} className="hover:text-accent-purple-light transition-colors">
                    ...
                    <td className="text-right px-3 py-2 text-xs font-medium text-text-primary tabular-nums">
